(() => {
    ...
    let bodyUnlock = (delay = 500) => {
        if (bodyLockStatus) {
            ...
            setTimeout((() => {
                ...
                document.querySelector("header.header").style.width = `100%`;
    ...
    let bodyLock = (delay = 500) => {
        if (bodyLockStatus) {
            ...
            document.querySelector("header.header").style.width = `calc(100% - ${lockPaddingValue})`;
 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const missionSliders = document.querySelectorAll(".our-mission__slider");
        missionSliders.forEach((slider => {
            new Splide(slider, {
                perPage: 1,
                arrows: false,
                pagination: true,
